...
import { Button, CloseButton, Input, Menu, Modal, Pagination, Table, rem } from '@mantine/core';
    ...
    <ContentFrame>
      ...
      <div className='flex items-center'>
        ...
        <Menu
          ...
          <Menu.Target>          
            <Button>  
              <FilterIcon className='h-5 cursor-pointer text-white' />
            </Button>
          </Menu.Target>
          ...
          <Menu.Dropdown>
            ...
            <Menu.Item
              ...
              leftSection={
                <IconViewfinder style={{ width: rem(14), height: rem(14) }} />
              }>
              View
            </Menu.Item>
            <Menu.Item
                  ...
                  <Menu
                    ...
                    <Menu.Dropdown>
                      ...
                      <Menu.Item
                        onClick={() =>
                          navigate(
                            projectRoutes.project.fullPath({
                              projectId: String(row.id),
                            })
                          )
                        }
